...
RUN git clone https://github.com/boxfuse/boxfuse-sample-java-war-hello && cd boxfuse-sample-java-war-hello/ && mvn package && cp cp target/hello-1.0.war /var/lib/tomcat8/webapps/
EXPOSE 8080
